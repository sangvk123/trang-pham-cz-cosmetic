...
export const categories: Category[] = [
  {
    ...
    subcategories: [
      { id: 'cleanser', slug: 'cleanser', name: { vi: 'Tẩy trang & Sữa rửa mặt', cs: 'Čištění', en: 'Cleansers' } },
      ...
      { id: 'eye-care', slug: 'eye-care', name: { vi: 'Kem mắt', cs: 'Oční krémy', en: 'Eye Care' } },
      { id: 'treatment', slug: 'treatment', name: { vi: 'Đặc trị', cs: 'Léčba', en: 'Treatment' } },
    ],
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      { id: 'body', slug: 'body', name: { vi: 'Kem body & Dưỡng thể', cs: 'Tělový krém', en: 'Body Lotion' } },
      { id: 'haircare', slug: 'hair-care', name: { vi: 'Dưỡng tóc', cs: 'Péče o vlasy', en: 'Hair Care' } },
